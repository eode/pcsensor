"""Tests for TEMPer Sensors for Temperature and Humidity api."""
import asyncio

import aiohttp
from custom_components.temper_sensors.api import (
    TemperApiClient,
)
...
async def test_api(hass, aioclient_mock, caplog):
    ...
    api = TemperApiClient("test", "test", async_get_clientsession(hass))
