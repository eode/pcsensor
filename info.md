...
1. Click install.
1. In the HA UI go to "Configuration" -> "Integrations" click "+" and search for "TEMPer Sensors for Temperature and Humidity".
...
[license]: https://github.com/eode/temper-sensors/blob/main/LICENSE
